...
// Dummy data for doctor's today's and tomorrow's appointments
...
const DoctorCompactAppointments = () => {
            ...
            <div className="flex items-start sm:items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-xs text-gray-500 flex items-center space-x-1 sm:space-x-2 mt-1">
                  ...
                  <span className="truncate hidden sm:inline">{appointment.duration}</span>
                </div>
                {/* Duration for mobile - separate line */}
...
export default DoctorCompactAppointments;
